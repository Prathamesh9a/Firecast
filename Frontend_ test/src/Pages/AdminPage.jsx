...
//     const res = await fetch("http://localhost:5000/api/upload/existingUrl", {
//       method: "GET",
//       headers: {
...
//           {/* <div className='z-40'>
//           <div className="z-40" style={{ zIndex: '40 !important' }}>
//             {previewUrl && (
//               <button className='z-40'>
//                 <div className="z-40 mt-6 p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-inner z-40">
//                   <p className="text-lg font-semibold z-40">Generated URL</p>
//                   <div className="flex items-center space-x-2 z-40">
//                     <p>{previewUrl}</p>
//                     <button
//                       onClick={handleCopy}
//                       className="px-2 py-1 text-sm font-medium text-blue-600 bg-blue-100 rounded hover:bg-blue-200 z-40"
//                     >
//                       Copy URL
//                     </button>
//                   </div>
...
//           {/* Content div with a higher z-index */}
//           <div className="z-50 relative">
//             {previewUrl && (
//               <button className='z-50'>
//                 <div className="z-50 mt-6 p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-inner z-50">
//                   <p className="text-lg font-semibold z-50">Generated URL</p>
//                   <div className="flex items-center space-x-2 z-50">
//                     <p>{previewUrl}</p>
//                     <button
//                     //   onClick={handleCopy}
//                       className="px-2 py-1 text-sm font-medium text-blue-600 bg-blue-100 rounded hover:bg-blue-200 z-50"
//                     >
//                       Copy URL
//                     </button>
//                   </div>
